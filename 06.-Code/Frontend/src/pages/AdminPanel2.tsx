...
import AdminPanel from "@/pages/AdminPanel"; // Importa el AdminPanel aquí
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-60 bg-gray-800 text-white flex flex-col p-4">
        ...
        <Link to="/admin" className="mb-2 bg-red-500 hover:bg-red-600 px-4 py-2 rounded">
          Panel Admin
        </Link>
      </div>
